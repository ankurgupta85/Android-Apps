...
*/
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		View exit_game =(View) findViewById(R.id.exit_game);
...
//		this.showMessage(text);
	...
	private void createFile() {
		...
		this.writeToFile("10:12 120 10\n");
		this.writeToFile("10:12 108 101\n");
		this.writeToFile("10:12 108 11110\n");
		this.writeToFile("10:12 120 11110\n");
	...
	private void writeToFile(String data) {
		try {
			OutputStreamWriter outputStreamWriter = new OutputStreamWriter(
					openFileOutput("hard.txt", MODE_APPEND));
