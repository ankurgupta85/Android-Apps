...
public class Easy_Scores extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		System.gc();
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_easy__scores);
		...
		try {
			// InputStream inputStream = openFileInput("easy.txt");
			Sort_Records records = new Sort_Records();
			Map<Long, ArrayList<String>> map = records.sort_records("easy.txt",
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.easy__scores, menu);
		return true;
	}
