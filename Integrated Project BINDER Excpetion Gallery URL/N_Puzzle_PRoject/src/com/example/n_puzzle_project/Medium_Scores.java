...
public class Medium_Scores extends Activity {

	@Override
	protected void onCreate(Bundle savedInstanceState) {
		System.gc();
		super.onCreate(savedInstanceState);
		setContentView(R.layout.activity_medium__scores);
		...
		try {
			/*
			 * InputStream inputStream = openFileInput("medium.txt");
			 * 
			 * if ( inputStream != null ) { InputStreamReader inputStreamReader
			 * = new InputStreamReader(inputStream); BufferedReader
			 * bufferedReader = new BufferedReader(inputStreamReader); String
			 * receiveString = ""; int i=0; while ( (receiveString =
			 * bufferedReader.readLine()) != null ) { i++; String data =
			 * receiveString;
			 */
			Sort_Records records = new Sort_Records();
			Map<Long, ArrayList<String>> map = records.sort_records(
					"medium.txt", getApplicationContext());
			int i = 0;
	...
	public boolean onCreateOptionsMenu(Menu menu) {
		...
		getMenuInflater().inflate(R.menu.medium__scores, menu);
		return true;
	}
