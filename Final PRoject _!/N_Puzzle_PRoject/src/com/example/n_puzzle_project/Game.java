...
public class Game extends Activity implements OnClickListener {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		// RelativeLayout page = (RelativeLayout)
		// findViewById(R.id.easy_game_layout);
	...
	private void displayDialog() {
		try {
			 ...
			 * game.addFlags(Intent.FLAG_ACTIVITY_CLEAR_TOP);
			 * game.putExtra("inputArray", input); game.putExtra("moves_count",
			 * 0); game.putExtra("no_rows", no_rows); game.putExtra("no_cols",
	...
	private void saveTempData() {
		...
		editor.commit();
		/*Toast.makeText(getApplicationContext(),
				"Saved " + file_name, Toast.LENGTH_LONG).show();
